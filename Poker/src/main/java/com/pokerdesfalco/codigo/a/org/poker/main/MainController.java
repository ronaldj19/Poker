 ...
 */
package com.pokerdesfalco.codigo.a.org.poker.main;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import com.pokerdesfalco.codigo.a.org.poker.main.strategies.RandomStrategy;
import com.pokerdesfalco.codigo.org.poker.api.game.GameException;
import com.pokerdesfalco.codigo.org.poker.api.game.IGameController;
import com.pokerdesfalco.codigo.org.poker.api.game.IStrategy;
import com.pokerdesfalco.codigo.org.poker.api.game.Settings;
import com.pokerdesfalco.codigo.org.poker.engine.controller.GameController;
import com.pokerdesfalco.codigo.org.poker.gui.TexasHoldEmView;
...
public final class MainController {
    ...
    public static void main(String[] args) throws InterruptedException, GameException {
        ...
        while (true) {
            ...
            IGameController controller = (IGameController) new GameController();
